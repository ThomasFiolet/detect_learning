...
graph_size = 100
f_save = open("maps/large_100/nodes", "w")
...
f_save = open("maps/large_100/distances_comma", "w")
for arr in adj:
    for d in arr:
...
with open("maps/large_100/distances_comma", "r") as file, open(r"maps/large_100/distances", "w") as target:
    target.write(file.read().replace(',\n','\n'))

os.remove("maps/large_100/distances_comma")
