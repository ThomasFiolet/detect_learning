...
files = [f for f in listdir('results_shortest_large/large_1000/loss') if isfile(join('results_shortest_large/large_1000/loss',f))]

f_save = open("results_shortest_large/large_1000/loss_agragated.csv", "w")
for f in files:
    data = []
...
files = [f for f in listdir('results_shortest_large/large_1000/results') if isfile(join('results_shortest_large/large_1000/results',f))]

f_save = open("results_shortest_large/large_1000/results_agragated.csv", "w")
...
for f in files:
    with open(join('results_shortest_large/large_1000/results', f), 'r') as csvfile:
        csv_reader = csv.reader(csvfile, delimiter=';')
        N_path_found = 0
        N_path_n = 0
